...
public class AccountingNodesTreeTest extends AccountingNodesTree {
    ...
    public void setUp() throws Exception {
        ...
        List<String> idWithMaxConsuption4 = new ArrayList<>();
        Pair<Float, List<String>> amountAndIdMaxConsumption4 = new Pair<>(0.0f, idWithMaxConsuption4);
        ...
        List<String> idWithMaxConsuption5 = new ArrayList<>("1.4.1");
        Pair<Float, List<String>> amountAndIdMaxConsumption5 = new Pair<>(234.0f, idWithMaxConsuption5);
        ...
        List<String> idWithMaxConsuption6 = new ArrayList<>();
        Pair<Float, List<String>> amountAndIdMaxConsumption6 = new Pair<>(0.0f, idWithMaxConsuption6);
        ...
        List<String> idWithMaxConsuption7 = new ArrayList<>();
        Pair<Float, List<String>> amountAndIdMaxConsumption7 = new Pair<>(0.0f, idWithMaxConsuption7);
        ...
        List<String> idWithMaxConsuption8 = new ArrayList<>("1.4.1.3");
        Pair<Float, List<String>> amountAndIdMaxConsumption8 = new Pair<>(203.0f, idWithMaxConsuption8);
        ...
        List<String> idWithMaxConsuption9 = new ArrayList<>();
        Pair<Float, List<String>> amountAndIdMaxConsumption9 = new Pair<>(0.0f, idWithMaxConsuption9);
        ...
        List<String> idWithMaxConsuption10 = new ArrayList<>();
        Pair<Float, List<String>> amountAndIdMaxConsumption10 = new Pair<>(0.0f, idWithMaxConsuption10);
        ...
        List<String> idWithMaxConsuption11 = new ArrayList<>();
        Pair<Float, List<String>> amountAndIdMaxConsumption11 = new Pair<>(0.0f, idWithMaxConsuption11);
        ...
        List<String> idWithMaxConsuption12 = new ArrayList<>();
        Pair<Float, List<String>> amountAndIdMaxConsumption12 = new Pair<>(0.0f, idWithMaxConsuption12);
    ...
    public void testGetDifferenceInConsumptionWithchildren() {
        ...
        entityList.forEach(entity -> {
            ...
            NodeId[] maxConsumptionVolume = {null};
